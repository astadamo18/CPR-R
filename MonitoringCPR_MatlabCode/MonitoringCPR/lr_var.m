%----------------------------------------------------------
% function [Omega,Delta,Sigma] = lr_var(u,kern,band,deme)
%
...
% Error corrected by KR and added line 70: Delta = Delta'; , April 2016 
%----------------------------------------------------------
function[Omega,Delta,Sigma] = lr_var(u,kern,band,deme)
...
for j = 1:j_max
    ...
    % Note: T1 and T2' some times minor numerical differences between 
...
Delta = Delta'; % Delta has to be transposed % Or use T_Delta = w(j)*T2 with Delta = Delta + T_Delta;   
